...
from django.views.generic import CreateView, UpdateView, DeleteView, ListView, TemplateView, View, DeleteView
...
def blog_details(request, slug):
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            ...
            comment.blog = blog
            comment.save()
            return HttpResponseRedirect(reverse('blogapp:blog_details', 
            kwargs={'slug':slug}))
...
class ShowProfile(ListView):
    ...
    template_name = 'loginapp/show_profile.html'
